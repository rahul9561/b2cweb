...
export default function CreditDeepAnalysisPage() {
  ...
  return (
    <main className="min-h-screen bg-blueBGMuted py-9">
      <div className="container-pb mb-6">
        <Link to="/" className="inline-flex items-center gap-1.5 text-sm font-medium text-slate2-secondary hover:text-brand">
