    ...
    <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
      ...
      {isOpen && (
        <div className="border-t border-slate-200 px-5 py-4 text-[12px] text-slate-600 space-y-3">
          ...
          <p>
            AV Management is an insurance services platform. Visitors are hereby informed that information
            submitted on the website may be shared with insurers and third-party administrators for service
            fulfilment.
          </p>
          <p>
